const PlanPayment = {
    name: "Công tác hoàn ứng",
    attribute: {
        code_of_payment_request_id: 'Mã hoàn ứng',
        total_amount_of_payment_request_id: 'Số tiền hoàn ứng',
        status_of_payment_request_id: 'Trạng thái hoàn ứng',
        is_accounting: 'Trạng thái hạch toán',
        code: "Mã kế hoạch",
        name: "Tên kế hoạch",

...
import title from '@columnTitles/vehicle-group';
import { useRef, useState } from 'react';
import { v4 } from 'uuid';
import { deleteRecord } from '../../../../apis/vehicle-group/vehicle-group';
    ...
    Modal.confirm({
      ...
      onOk() {
        deleteRecord(record.id)
          .then(() => {
            message.success(`Xóa thành công nhóm phương tiện ${record.code}`);
            reloadTable();
          })
          .catch((error) => {
  ...
  return (
    <>
      ...
      <Modal
        ...
        title={`${idEdit ? 'Sửa' : 'Thêm'} nhóm phương tiện`}
        footer={[
      ...
      <Modal
        ...
        title={`Chi tiết nhóm phương tiện`}
        footer={[

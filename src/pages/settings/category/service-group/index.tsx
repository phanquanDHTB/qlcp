...
import title from '@columnTitles/service-group';
import { useRef, useState } from 'react';
import { v4 } from 'uuid';
import { deleteRecord } from '../../../../apis/service-group/service-group';
    ...
    Modal.confirm({
      ...
      onOk() {
        deleteRecord(record.id)
          .then(() => {
            message.success(`Xóa thành công nhóm dịch vụ ${record.code}`);
            reloadTable();
          })
          .catch((error) => {
  ...
  return (
    <>
      ...
      <Modal
        ...
        title={`${idEdit ? 'Sửa' : 'Thêm'} nhóm dịch vụ`}
        footer={[

...
import title from '@columnTitles/service';
import { useRef, useState } from 'react';
import { v4 } from 'uuid';
import { deleteRecord } from '../../../../apis/service/service';
    ...
    Modal.confirm({
      ...
      onOk() {
        deleteRecord(record.id)
          .then(() => {
            message.success(`Xóa thành công dịch vụ ${record.code}`);
            reloadTable();
          })
          .catch((error) => {

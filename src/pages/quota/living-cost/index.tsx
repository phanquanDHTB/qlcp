...
import title from '@columnTitles/living_cost_quota';
  ...
  return (
    <>
      <BasePage
        ...
        fetchParams={{
          serviceGroupId: Constants.categoryDefault.serviceGroup.SINH_HOAT_PHI.id,
        }}
        columnTiles={title}
        columns={columns}
        isAddButton
      ...
      />
      <Modal
        title={`${idEdit ? 'Sửa' : 'Thêm'} định mức sinh hoạt phí`}
        destroyOnClose={true}
        style={{
          top: 20,
          height: '60vh',
      ...
      <Modal
        title={`Chi tiết định mức sinh hoạt phí`}
        destroyOnClose={true}
        style={{
          top: 20,
          height: '70vh',
